...
export default class MyWordsNewCourse extends React.Component {
	...
	render() {
		...
		return <View
				style={styles.mywordsNewcourseView}>
				<View
				...
				<View
					...
					<View
						...
						<Text
							style={styles.labelText}>New Course</Text>
						<TouchableOpacity
